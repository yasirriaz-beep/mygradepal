export const CHEMISTRY_VIDEOS = [
    ...
    videos: [
      {
        ...
        timestamps: [
          ...
          { time: "3:51", label: "Changes of state" },
          { time: "8:16", label: "Heating and cooling curves" },
          { time: "10:18", label: "Gas volume and pressure" },
          { time: "12:03", label: "Diffusion" },
        ]
      }
    ]
  },
    ...
    videos: [
      {
        ...
        timestamps: [
          { time: "0:00", label: "Atomic structure" },
          { time: "2:30", label: "Atomic number and mass number" },
          { time: "5:00", label: "Electron configuration" },
          { time: "8:00", label: "Isotopes" },
        ]
      },
      {
        part: 2,
        youtube_id: "H27iLlN1CAs",
        title: "Atoms, Elements & Compounds Part 2 — Bonding",
        channel: "IGCSE Study Buddy",
        summary: "Covers ionic bonding, covalent bonding, metallic bonding, and properties of each bond type.",
        timestamps: [
          { time: "0:00", label: "Ionic bonding" },
          { time: "4:00", label: "Covalent bonding" },
          { time: "8:00", label: "Metallic bonding" },
        ]
      }
    ]
  },
    ...
    videos: [
      {
        ...
        timestamps: [
          ...
          { time: "4:00", label: "Electrolysis of water" },
          { time: "6:00", label: "Electrolysis of brine" },
          { time: "8:00", label: "Electroplating" },
        ]
      }
    ]
  },
    ...
    videos: [
      {
        ...
        timestamps: [
          { time: "0:00", label: "Exothermic reactions" },
          { time: "2:00", label: "Endothermic reactions" },
          { time: "4:00", label: "Energy profile diagrams" },
          { time: "6:00", label: "Bond energies" },
          { time: "8:00", label: "Calculations" },
        ]
      }
    ]
  },
    ...
    videos: [
      {
        ...
        timestamps: [
          ...
          { time: "4:00", label: "Neutralisation" },
          { time: "6:00", label: "Salt preparation" },
          { time: "8:00", label: "Titration" },
        ]
      }
    ]
  },
    ...
    videos: [
      {
        ...
        timestamps: [
          ...
          { time: "4:00", label: "Group 7 properties" },
          { time: "6:00", label: "Period 3 trends" },
          { time: "8:00", label: "Transition metals" },
        ]
      }
    ]
  },
    ...
    videos: [
      {
        ...
        timestamps: [
          ...
          { time: "4:00", label: "Extraction of metals" },
          { time: "6:00", label: "Rusting and prevention" },
          { time: "8:00", label: "Alloys" },
        ]
      }
    ]
  },
    ...
    videos: [
      {
        ...
        channel: "IGCSE Study Buddy",
        summary: "Covers water treatment, hard water, air pollution, greenhouse effect, global warming, fertilisers, and eutrophication.",
        timestamps: [
          { time: "0:00", label: "Water treatment" },
          { time: "2:00", label: "Hard water" },
          { time: "4:00", label: "Air pollution" },
          { time: "6:00", label: "Greenhouse effect" },
  ...
  {
    topic: "Experimental Techniques & Analysis",
    videos: [
      {
        part: 1,
        ...
        timestamps: [
          { time: "0:00", label: "Filtration and evaporation" },
          { time: "2:00", label: "Distillation" },
          { time: "4:00", label: "Chromatography and Rf values" },
          { time: "6:00", label: "Flame tests" },
          { time: "8:00", label: "Ion and gas tests" },
        ]
      }
    ]
  },
...
export type ChemistryVideo = typeof CHEMISTRY_VIDEOS[0]["videos"][0];
export type ChemistryTopic = typeof CHEMISTRY_VIDEOS[0];
